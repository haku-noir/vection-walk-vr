...
> 詳細は [../viewpoint-following/06_roadmap-viewpoint-following.md](../viewpoint-following/06_roadmap-viewpoint-following.md) を参照。
...
├── docs/                   ★ このドキュメント（Unityの外に置き .meta を発生させない）
│   ├── reversed-vision/    　 前任者のプロジェクトの説明
│   └── viewpoint-following/　 視点追従実験のドキュメント
